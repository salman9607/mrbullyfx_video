                     ...
                     <div class="col-md-8">
                        <div class="single-video-left">
                           ...
                           <div class="single-video-author box mb-3">
                              ...
                              <p><a href="#"><strong>Shelly Channel</strong></a> <span title="" data-placement="top" data-toggle="tooltip" data-original-title="Verified"><i class="fas fa-check-circle text-success"></i></span></p>
                              <small>Published on May 10, 2019</small> --}}
                           </div>
                              ...
                              <div class="col-md-12">
                                 ...
                                 <div class="video-card video-card-list">
                                    <div class="video-card-image">
                                       ...
                                       <a href="{{ route('play_video', $video->slug) }}"><img class="img-fluid" src="{{ asset('storage/app/'.$video->thumbnail) }}" alt=""></a>
                                    ...
                                    <div class="video-card-body">
                                       <div class="btn-group float-right right-action">
                                          ...
                                          <div class="dropdown-menu dropdown-menu-right">
                                             <a class="dropdown-item" href="#"><i class="fas fa-fw fa-times-circle"></i> &nbsp; Not Interested</a>
                                          </div>
                                       </div>
                                       ...
                                       <div class="video-view">
                                          {{ $video->views }} views &nbsp;<i class="fas fa-calendar-alt"></i> {{ Carbon\Carbon::parse($video->created_at)->diffForHumans()}}
                                       </div>
                                    </div>
                                 </div>
                                 @endforeach
